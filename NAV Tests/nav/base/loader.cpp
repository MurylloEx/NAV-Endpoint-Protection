	...
	OUT SIZE_T *BufferSize)
{
	...
	*(DWORD64*)((DWORD64)Shellcode + 98) = (DWORD64)POriginalRip;
	...
	OUT SIZE_T *BufferSize)
{
	...
	*(DWORD32*)((DWORD32)Shellcode + 7) = (DWORD32)PRtlInitUnicodeString;
	*(DWORD32*)((DWORD32)Shellcode + 12) = (DWORD32)PSourceString;
	*(DWORD32*)((DWORD32)Shellcode + 17) = (DWORD32)PTargetUnicodeString;
	*(DWORD32*)((DWORD32)Shellcode + 24) = (DWORD32)PLdrLoadDll;
	*(DWORD32*)((DWORD32)Shellcode + 29) = (DWORD32)PModuleHandle;
	*(DWORD32*)((DWORD32)Shellcode + 34) = (DWORD32)PModuleFileName;
	*(DWORD32*)((DWORD32)Shellcode + 51) = (DWORD32)POriginalEip;
...
CLEANUP:
	VirtualFreeEx(ProcessHandle, RemoteAddress, BufferSize, MEM_RELEASE);
	return FALSE;
}
