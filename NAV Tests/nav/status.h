...
#define NAV_SET_ACE_STATUS_KERNEL_OBJECT_CHANGE_FAILED	0x00UL
#define NAV_SET_ACE_STATUS_SUCCESS						0x01UL
#define NAV_SET_ACE_STATUS_UNKNOWN_BUFFER_SIZE			0x02UL
#define NAV_SET_ACE_STATUS_MEMORY_ALLOCATION_FAILED		0x04UL
#define NAV_SET_ACE_STATUS_UNKNOWN_SECURITY_DESCRIPTOR	0x08UL
#define NAV_SET_ACE_STATUS_DACL_CHANGE_FAILED			0x10UL
#define NAV_SET_ACE_STATUS_DESCRIPTOR_CHANGE_FAILED		0x20UL
#define NAV_SET_ACE_STATUS_RETRIEVE_DACL_FAILED			0x40UL

#define NAV_CREATE_SID_STATUS_MEMORY_ALLOCATION_FAILED	0x00UL
#define NAV_CREATE_SID_STATUS_SUCCESS					0x01UL
#define NAV_CREATE_SID_STATUS_SID_CREATION_FAILED		0x02UL
...
#define NAV_NAMED_PIPE_STATUS_FAILED					0x00UL
#define NAV_NAMED_PIPE_STATUS_SUCCESS					0x01UL
